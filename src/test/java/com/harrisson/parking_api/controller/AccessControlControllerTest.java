...
public class AccessControlControllerTest {
    ...
    public void testRegisterEntry() throws Exception {
        ...
        Mockito.when(accessControlService.registerEntry("HRT-5038", Type.CAR, 1L)).thenReturn(accessControl);
    ...
    public void testRegisterExit() throws Exception {
        AccessControl accessControl = new AccessControl();
        Mockito.when(accessControlService.registerExit("HWD-5309")).thenReturn(accessControl);
